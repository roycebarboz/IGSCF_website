    ...
    <section className="py-14 px-8 bg-[#faf6f0]">
      <div className="max-w-5xl mx-auto flex items-center justify-between gap-8">
        <div className="flex-1">
          ...
          <button className="bg-[#e89c2f] text-white text-sm font-semibold px-5 py-2.5 rounded-full hover:bg-[#f0b84a] transition-colors">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="bg-white rounded-xl p-3 border-2 border-[#e89c2f]">
